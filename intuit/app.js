!(function ($) {
   ...
   * ---------------------------------------------------------------------------
   * 
   * OAuth Consumer Key qyprdKM4PFrmps9dsITKCvQJYz3MWF
   * OAuth Consumer Secret ROOrcEJ7oFMu369XZFbACpE6aNLvWiUKicBwdUB2
   * SAML Identity Provider ID swipeouttestapi.210141.cc.dev-intuit.ipp.prod
   * 
   * X.509 Public Certificate
   * Serial Number First Certificate: 009EA3C932E9F8EBA6 (expires on 7/29/2015)
   *
   * Consumer Key qyprdKM4PFrmps9dsITKCvQJYz3MWF
   * Consumer Secret ROOrcEJ7oFMu369XZFbACpE6aNLvWiUKicBwdUB2
   * Access Token (temporary token obtained using SAML ID below) qyprdUCtxgfIZYqUblNvycGE1SQl85zMyR6QLJnUU8jWmXon
   * Access Token Secret (temporary token secret obtained using SAML ID below) UPK3IHM5D1KDOf4zdBRfuCjZP4RwOjpVlx6JFsVK
   * SAML Identity Provider ID swipeouttestapi.210141.cc.dev-intuit.ipp.prod
   * End User ID alex@fiftyandfifty.org
   */
