      ...
      <ul class="nav navbar-nav">
        <li class="character-nav dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li><a href="json-live-search/">JSON Live Search</a></li>
          </ul>
        </li>
      </ul>
    </div><!--/.nav-collapse -->
...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-6 col-md-4">
      <div class="thumbnail">
        ...
        <div class="caption">
          ...
          <p><a href="characters/" class="btn btn-primary" role="button">View</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-6 col-md-4">
      <div class="thumbnail">
        ...
        <div class="caption">
          ...
          <p><a href="reddit/" class="btn btn-primary" role="button">View</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-6 col-md-4">
      <div class="thumbnail">
        ...
        <div class="caption">
          ...
          <p><a href="nfl/" class="btn btn-primary" role="button">View</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-6 col-md-4">
      <div class="thumbnail">
        ...
        <div class="caption">
          ...
          <p><a href="terrain/" class="btn btn-primary" role="button">View</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-6 col-md-4">
      <div class="thumbnail">
        ...
        <div class="caption">
          ...
          <p><a href="geonote/" class="btn btn-primary" role="button">View</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-6 col-md-4">
      <div class="thumbnail">
        <img src="json-live-search/screenshot.png" style="width:100%;height:270px;">
        <div class="caption">
          <h3>JSON Live Search</h3>
          <p>Tutorial for creating a live json search</p>
          <p><a href="json-live-search/" class="btn btn-primary" role="button">View</a>
        </div>
      </div>
    </div>
