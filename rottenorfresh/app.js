!(function ($) {
  ...
  /**
   * Rotten or Fresh
   * fafq8wbpu2fp35ym29wktmmx
   * http://api.rottentomatoes.com/api/public/v1.0.json?apikey=fafq8wbpu2fp35ym29wktmmx
   * http://api.rottentomatoes.com/api/public/v1.0/movies.json?apikey=fafq8wbpu2fp35ym29wktmmx
   * http://api.rottentomatoes.com/api/public/v1.0/movies.json?apikey=fafq8wbpu2fp35ym29wktmmx&q=Toy+Story+3&page_limit=1
   */
  App.rotten = {
    ...
    getMovies: function(callback) {
      ...
      .done(function (data) {
        ...
        for ( var key in data ) {
          App.data.rotten.temp[key] = data[key];
        }
     ...
     * Get Movies
     */
    getMoviesByYear: function(year, callback) {
    ...
    getMovieDetails: function(callback) {
      this.getMoviesByYear('2014', function (data) {
        ...
        var i = setInterval(function(){
            ...
            $.ajax({
              url: 'http://api.rottentomatoes.com/api/public/v1.0/movies.json?apikey=fafq8wbpu2fp35ym29wktmmx&q='+data[index].name,
              type: 'GET',
              dataType: 'jsonp'
            })
            .done(function (data) {
            ...
            index++;
            if( index == data.length ) { clearInterval(i); }
        }, 5000);
