...
require = (function e(h, j, l) {
    ...
    56: [function(i, h, f) {
        var g = {
            ...
            BE_FR: {
                code: "bf",
                noResults: "Pas de rÃ©sultat. Essayez une recherche apple.com",
                viewAll: "Afficher tous les rÃ©sultats",
            ...
            BR: {
                code: "br",
                noResults: "NÃ£o encontrado. Tente a busca em apple.com",
            ...
            CN: {
                code: "cn",
                directory: "/cn",
                noResults: "æ‰¾ä¸åˆ°å¿«é€Ÿæœç´¢ç»“æžœï¼Œè¯·å°è¯• apple.com çš„å®Œæ•´æœç´¢",
                recommendedResults: "å¿«é€Ÿé“¾æŽ¥",
                viewAll: "æŸ¥çœ‹æ‰€æœ‰æœç´¢ç»“æžœ",
                searchText: "æœç´¢"
            },
            DE: {
                code: "de",
            ...
            DK: {
                code: "dk",
                noResults: "Ingen genvej fundet. PrÃ¸v at sÃ¸ge pÃ¥ hele apple.com.",
                viewAll: "Vis alle sÃ¸geresultater",
                recommendedResults: "Hurtige henvisninger",
                searchText: "SÃ¸g"
            },
            ES: {
                code: "es",
                noResults: "NingÃºn atajo. BÃºsqueda completa en apple.com",
                viewAll: "Ver todos los resultados de bÃºsqueda",
                recommendedResults: "Enlaces rÃ¡pidos",
                searchText: "Buscar"
            },
            FI: {
                code: "fi",
                noResults: "Ei oikotietÃ¤. Etsi koko apple.com.",
            ...
            HK: {
                code: "hk",
                noResults: "æ‰¾ä¸åˆ°å¿«é€Ÿæœå°‹çµæžœï¼Œè«‹è©¦è©¦ apple.com çš„å®Œæ•´æœå°‹",
                viewAll: "æª¢è¦–æ‰€æœ‰æœå°‹çµæžœ",
                recommendedResults: "å¿«é€Ÿé€£çµ",
                searchText: "æœå°‹"
            },
            HK_EN: {
                code: "hk",
            ...
            JP: {
                code: "jp",
                noResults: "ã‚·ãƒ§ãƒ¼ãƒˆã‚«ãƒƒãƒˆã¯è¦‹ã¤ã‹ã‚Šã¾ã›ã‚“ã§ã—ãŸã€‚æ¤œç´¢ã¯ã“ã¡ã‚‰ã€‚",
                viewAll: "ã™ã¹ã¦ã®æ¤œç´¢çµæžœã‚’è¦‹ã‚‹",
                recommendedResults: "ã‚¯ã‚¤ãƒƒã‚¯ãƒªãƒ³ã‚¯",
                searchText: "Search"
            },
            KR: {
                code: "kr",
                noResults: "ì¼ì¹˜í•˜ëŠ” ê²€ìƒ‰ê²°ê³¼ê°€ ì—†ìŠµë‹ˆë‹¤. ë‹¤ì‹œ ê²€ìƒ‰í•˜ê¸°.",
                recommendedResults: "ë¹ ë¥¸ ì—°ê²°",
                viewAll: "ê²€ìƒ‰ ê²°ê³¼ ì „ì²´ ë³´ê¸°."
            },
            LA: {
                code: "la",
                noResults: "No se encontraron resultados. Intenta en apple.com.",
                viewAll: "Ver todos los resultados de la bÃºsqueda",
                recommendedResults: "Enlaces rÃ¡pidos",
                searchText: "Buscar"
            },
            LAE: {
            ...
            NO: {
                code: "no",
                noResults: "Fant ingen snarvei. SÃ¸k pÃ¥ hele apple.com.",
                viewAll: "Vis alle sÃ¸keresultater",
            ...
            PL: {
                code: "pl",
                noResults: "Fraza nie zostaÅ‚a odnaleziona. UÅ¼yj apple.com.",
                viewAll: "PrzeglÄ…daj wszystkie wyniki",
                recommendedResults: "PodrÄ™czne Å‚Ä…cza",
                searchText: "Szukaj"
            },
            PT: {
                code: "pt",
                ...
                recommendedResults: "LigaÃ§Ãµes rÃ¡pidas",
                searchText: "Procurar"
            },
            RU: {
                code: "ru",
                noResults: "Ð¡ÑÑ‹Ð»Ð¾Ðº Ð½ÐµÑ‚. ÐŸÐ¾Ð¿Ñ€Ð¾Ð±ÑƒÐ¹Ñ‚Ðµ Ñ€Ð°ÑÑˆÐ¸Ñ€ÐµÐ½Ð½Ñ‹Ð¹ Ð¿Ð¾Ð¸ÑÐº.",
                viewAll: "ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð²ÑÐµ Ñ€ÐµÐ·ÑƒÐ»ÑŒÑ‚Ð°Ñ‚Ñ‹ Ð¿Ð¾Ð¸ÑÐºÐ°",
                recommendedResults: "Ð‘Ñ‹ÑÑ‚Ñ€Ñ‹Ðµ ÑÑÑ‹Ð»ÐºÐ¸",
                searchText: "ÐŸÐ¾Ð¸ÑÐº"
            },
            SA: {
                code: "sa"
            },
            SE: {
                code: "se",
                noResults: "Ingen genvÃ¤g hittad. SÃ¶k i hela apple.com.",
                viewAll: "Visa alla sÃ¶kresultat",
                recommendedResults: "SnabblÃ¤nkar",
                searchText: "SÃ¶k"
            },
            SG: {
                code: "sg"
            ...
            TR: {
                code: "tr",
                noResults: "Ã–neri bulunamadÄ±. TÃ¼m apple.com'da ara.",
                viewAll: "TÃ¼m arama sonuÃ§larÄ±nÄ± gÃ¶ster",
                recommendedResults: "Ã–nerilen SonuÃ§lar",
                searchText: "Arama"
            },
            TW: {
                code: "tw",
                noResults: "å¿«é€Ÿæœå°‹æ‰¾ä¸åˆ°ï¼Œè©¦è©¦ apple.com å®Œæ•´æœå°‹",
                viewAll: "ç€è¦½æœç´¢çµæžœ",
                recommendedResults: "å¿«é€Ÿé€£çµ",
                searchText: "æœå°‹"
            },
            UK: {
