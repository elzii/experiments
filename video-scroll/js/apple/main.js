...
! function(m) {
    function n(b, c) {
        var f, d, a = b.map(function(g) {
            return "exports" === g ? f = {} : "module" === g ? d = {
                exports: {}
    ...
    function k(d, a) {
        ...
        if (d && "." === d.charAt(0)) {
            if (a) {
                for (b.pop(), d = d.split("/"), d = b.concat(d), c = 0; c < d.length; c += 1) {
                    if ("." === d[c]) {
                        d.splice(c, 1), c -= 1
                    } else {
                        if (".." === d[c]) {
                            ...
                            c > 0 && (d.splice(c - 1, 2), c -= 2)
                        }
                    }
                }
                d = d.join("/")
            } else {
                0 === d.indexOf("./") && (d = d.substring(2))
            }
        }
        return d
    }
    ...
    function o(b, a) {
        var c;
        return "string" == typeof b ? (b = k(b), c = i[b], c || "function" != typeof j || (c = j(b)), c) : "function" == typeof a && Array.isArray(b) ? a.apply(m, n(b).deps) : void 0
    }

    function l(d, b, c) {
        if (!i[d]) {
            if (c || (c = b), "function" == typeof c && Array.isArray(b)) {
                var a = n(b, d);
                ...
                i[d] = "function" == typeof c ? c() : c
            }
        }
    }
    var i, j;
    o.version = "1.4.0", o.config = function() {}, l.amd = {}, o._init = function() {
        i = {}
    }, l.getRegisteredModules = function() {
        return Object.getOwnPropertyNames(i).sort()
    }, l.getRegisteredNamespaces = function() {
        var b = l.getRegisteredModules(),
            a = {};
        return b.forEach(function(d) {
            var c = d.split("/")[0];
            a[c] || (a[c] = []), a[c].push(d)
        }), a
    }, o._init(), "function" == typeof m.define && m.define.amd || (j = m.require, m.require = o, m.define = l)
}(this);
require = (function e(h, j, l) {
    ...
    "ac-deferred": [function(d, g, f) {
        g.exports = d("gpsNR2")
    }, {}],
    gpsNR2: [function(q, p, k) {
                        ...
                        if (f[0] === "$super") {
                            b[g] = (function(t, u) {
                                ...
                                return function h() {
                                    ...
                                    return u.apply(this, [i.bind(this)].concat(r))
                                }
                            }(g, d))
                        }
                    }
    ...
    31: [function(l, k, m) {
        ...
        (function() {
            ...
            h.cssPropertyAvailable = function(z) {
                if (b === null) {
                ...
                z = z.replace(/([A-Z]+)([A-Z][a-z])/g, "$1\\-$2").replace(/([a-z\d])([A-Z])/g, "$1\\-$2").replace(/^(\-*webkit|\-*moz|\-*o|\-*ms|\-*khtml)\-/, "").toLowerCase();
                switch (z) {
                    case "gradient":
                        ...
                        b.cssText = (z + a.join(f + z) + a.join(g + z)).slice(0, -z.length);
                    ...
                    default:
                        ...
                        if (u.length > 0) {
                            z = u[0];
                            for (w = 1; w < y; w += 1) {
                                z += u[w].substr(0, 1).toUpperCase() + u[w].substr(1)
                            }
                        }
                        v = z.substr(0, 1).toUpperCase() + z.substr(1);
                        if (c[z] !== undefined) {
                            return c[z]
                        }
                        for (x = d.length - 1; x >= 0; x -= 1) {
                            if (b[d[x] + z] !== undefined || b[d[x] + v] !== undefined) {
                                c[z] = true;
                                return true
                            }
                        }
...
require = (function e(h, j, l) {
    ...
    5: [function(t, u, s) {
        ...
        var l = {
            ...
            nothreedTransform: "no-threedtransform",
            sticky: "sticky",
            noSticky: "no-sticky",
            ios: "ios",
            media: "media",
        ...
        var q = function() {
            ...
            this._classTarget = document.documentElement;
            this.supportMatrix = {}
        };
        p = q.prototype;
        p.initialize = function() {
            ...
            this.setJSClass();
            this.setBrowserTypeClass();
            this.setTouchClass();
            this.setIOSClasses();
            this.setSVGClass();
            this.setCanvasClass();
            this.setThreedTransformClass();
            this.setStickyClass();
            this.setMediaIntroTypeClass();
            this._didInitialize = true
        };
        p.getBrowserClassNames = function() {
            return m
        };
        p.getJSClassNames = function() {
            return n
        };
        p.getViewportClassNames = function() {
            return l
        };
        p.removeNoJSClass = function() {
            o.removeClassName(this._classTarget, n.noJS)
        };
        p.setJSClass = function() {
            o.addClassName(this._classTarget, n.hasJS)
        };
        p.setBrowserTypeClass = function() {
            var a = null,
                b = r.Browser.name,
                c = r.Browser.version;
            if (b === "Firefox") {
            ...
            if (a) {
                o.addClassName(this._classTarget, a)
            }
        };
        p.setIOSClasses = function() {
            if (r.Browser.os !== "iOS") {
                return
            }
            o.addClassName(this._classTarget, l.ios);
            o.addClassName(this._classTarget, l.ios + "-" + r.Browser.version)
        };
        p.setTouchClass = function() {
            var a = l.noTouch;
            if (r.Feature.touchAvailable()) {
                a = l.touch
            }
            o.addClassName(this._classTarget, a)
        };
        p.setSVGClass = function() {
            var a = l.noSvg;
            if (r.Feature.svgAvailable()) {
                a = l.svg
            }
            o.addClassName(this._classTarget, a)
        };
        p.setCanvasClass = function() {
            if (r.Feature.canvasAvailable()) {
                o.addClassName(this._classTarget, l.canvas)
            }
        };
        p.setThreedTransformClass = function() {
            var a = l.nothreedTransform;
            if (r.Feature.threeDTransformsAvailable()) {
                a = l.threedTransform
            }
            o.addClassName(this._classTarget, a)
        };
        p.setStickyClass = function() {
            var c = "position:",
                a = document.createElement("div"),
                b = l.noSticky;
            a.style.cssText = c + ["-webkit-", "-moz-", "-ms-", "-o-", ""].join("sticky;" + c) + "sticky;";
            if (a.style.position.indexOf("sticky") !== -1) {
                b = l.sticky
            }
            if (r.Browser.version < 7) {
                b = l.noSticky
            }
            o.addClassName(this._classTarget, b)
        };
        p.canUseMP4Video = function() {
            if (this._mp4Support !== null) {
                return this._mp4Support
            }
            try {
                var b = document.createElement("VIDEO");
                if (b.canPlayType && b.canPlayType("video/mp4").replace(/no/, " ")) {
                    this._mp4Support = true;
                    return true
                }
            } catch (a) {}
            this._mp4Support = false;
            return false
        };
        p.setMediaIntroTypeClass = function() {
            if (AC.Environment.Feature.supportsThreeD() || r.Browser.name === "Firefox") {
                o.addClassName(this._classTarget, l.media);
                o.addClassName(this._classTarget, l.heroIntro)
            }
        };
        p.canUseFlow = function() {
            return r.Feature.canvasAvailable()
        };
        u.exports = new q()
    }, {
        "ac-base": false
